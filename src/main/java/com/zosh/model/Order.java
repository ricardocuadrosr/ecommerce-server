...
public class Order {
	...
	@Embedded
	private PaymentDetails paymetDetails = new PaymentDetails();
	...
	public Order(Long id, String orderId, User user, List<OrderItem> orderItems, LocalDateTime orderDate,
			LocalDateTime deliveryDate, Address shippingAddress, PaymentDetails paymetDetails, double totalPrice,
		...
		this.paymetDetails = paymetDetails;
	...
	public PaymentDetails getPaymetDetails() {
		return paymetDetails;
	}


	public void setPaymetDetails(PaymentDetails paymetDetails) {
		this.paymetDetails = paymetDetails;
	}
